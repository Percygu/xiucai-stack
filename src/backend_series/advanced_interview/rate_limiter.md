---
title: 38. 如何设计一个百万QPS的限流器？
description: "系统设计面试题：架构设计面试题、场景题面试常考点，百万QPS限流器设计方案，详解令牌桶、漏桶、滑动窗口算法原理及分布式限流实现。"
tags:
  - 场景题
  - 面试题
  - 短链
...
![](../../assets/img/后端进阶之路/面试场景题/限流器/2.png)
...
![](../../assets/img/后端进阶之路/面试场景题/限流器/3.png)
