...
![MySQL执行查询过程](../../assets/img/后端进阶之路/mysql面试题/msyql查询过程.png)
...
![MVCC多版本并发控制原理](../../assets/img/后端进阶之路/mysql面试题/mvcc原理.png)
...
![MySQL聚簇索引结构](../../assets/img/后端进阶之路/mysql面试题/聚簇索引.png)

非聚簇索引如下图：

![MySQL非聚簇索引结构](../../assets/img/后端进阶之路/mysql面试题/非聚簇索引.png)
...
![B+树索引结构](../../assets/img/后端进阶之路/mysql面试题/B+树.png)
...
![MySQL联合索引B+树结构](../../assets/img/后端进阶之路/mysql面试题/联合索引.png)
...
![MySQL覆盖索引与回表查询](../../assets/img/后端进阶之路/mysql面试题/覆盖索引.png)
...
![联合索引区分度查询示例](../../assets/img/后端进阶之路/mysql面试题/联合查询效率1.png)

对于已经创建好的索引，我们还可以使用MySQL命令查看每个索引的区分度排名：

![索引区分度排名查询](../../assets/img/后端进阶之路/mysql面试题/联合查询效率2.png)
...
![MySQL索引下推优化原理](../../assets/img/后端进阶之路/mysql面试题/索引下推.png)
...
![自增主键顺序插入B+树](../../assets/img/后端进阶之路/mysql面试题/自增主键1.gif)

插入非连续的数据：

![非自增主键随机插入导致页分裂](../../assets/img/后端进阶之路/mysql面试题/自增主键2.gif)
...
![MySQL记录锁示意图](../../assets/img/后端进阶之路/mysql面试题/记录锁.png)
...
![MySQL临键锁示意图](../../assets/img/后端进阶之路/mysql面试题/临键锁.png)
...
![版本号乐观锁工作流程](../../assets/img/后端进阶之路/mysql面试题/版本号乐观锁.png)
...
![Redo Log环形写入方式](../../assets/img/后端进阶之路/mysql面试题/redolog写入方式.png)
...
![Redo Log innodb_flush_log_at_trx_commit参数](../../assets/img/后端进阶之路/mysql面试题/redolog写入.png)
...
![MySQL两阶段提交流程](../../assets/img/后端进阶之路/mysql面试题/两阶段提交.png)
...
![Binlog刷盘策略sync_binlog参数](../../assets/img/后端进阶之路/mysql面试题/binlog刷盘.png)
...
![MySQL主从复制架构流程](../../assets/img/后端进阶之路/mysql面试题/主从复制.png)
...
![垂直分库示意图](../../assets/img/后端进阶之路/mysql面试题/垂直分库.png)

分表

![水平分表示意图](../../assets/img/后端进阶之路/mysql面试题/分表.png)
...
![跨库查询微服务聚合方案](../../assets/img/后端进阶之路/mysql面试题/跨库查询.png)
