...
![Go数组与切片的区别示意图](../../assets/img/go语言系列/go面试题库/基础面试题/image.png)
...
![Go init函数执行顺序](../../assets/img/go语言系列/go面试题库/基础面试题/image-1.png)
...
![Go函数返回值栈空间示意图](../../assets/img/go语言系列/go面试题库/基础面试题/image-2.png)
...
![Go Slice底层数据结构](../../assets/img/go语言系列/go面试题库/Slice面试题/image.png)
...
![Slice切片操作示意图](../../assets/img/go语言系列/go面试题库/Slice面试题/image-1.png)
...
![Slice append操作示意图](../../assets/img/go语言系列/go面试题库/Slice面试题/image-2.png)
...
![Slice扩容机制示意图](../../assets/img/go语言系列/go面试题库/Slice面试题/image-3.png)
...
![Slice扩容后独立内存示意图](../../assets/img/go语言系列/go面试题库/Slice面试题/image-4.png)
...
![Go Map hmap底层结构](../../assets/img/go语言系列/go面试题库/Map面试题/image-2.png)

bmap结构如下：

![Go Map bmap桶结构](../../assets/img/go语言系列/go面试题库/Map面试题/image-1.png)
...
![Go Map delete操作内存示意图](../../assets/img/go语言系列/go面试题库/Map面试题/image.png)
...
![Go Channel底层数据结构](../../assets/img/go语言系列/go面试题库/Channel面试题/image.png)
...
![Channel sender向receiver发送数据流程](../../assets/img/go语言系列/go面试题库/Channel面试题/image-1.png)
...
![Channel直接发送数据到receiver栈](../../assets/img/go语言系列/go面试题库/Channel面试题/image-3.png)
...
![Channel优雅关闭示例代码](../../assets/img/go语言系列/go面试题库/Channel面试题/image-2.png)
...
![Mutex state字段二进制位标识](../../assets/img/go语言系列/go面试题库/Sync面试题/0c8666c9f2a2a24045c7eb16c163a8e9.png)

sema表示信号量，mutex阻塞队列的定位是通过这个变量来实现的，从而实现goroutine的阻塞和唤醒

![Mutex sema信号量阻塞队列](../../assets/img/go语言系列/go面试题库/Sync面试题/cacc64449f25f934740cbdf201affbf3.png)
...
![sync.Pool底层结构示意图](../../assets/img/go语言系列/go面试题库/Sync面试题/10a8fc3bc4fe8c3b2d23a0832aabb5f2.png)
...
![Context使用场景示意图](../../assets/img/go语言系列/go面试题库/Context面试题/image-1.png)
...
![Context.Value链式查找过程](../../assets/img/go语言系列/go面试题库/Context面试题/image.png)
...
![Context级联取消机制示意图](../../assets/img/go语言系列/go面试题库/Context面试题/image-2.png)
...
![Go eface空接口底层结构](../../assets/img/go语言系列/go面试题库/Interface面试题/eface修改.png)
...
![Go iface非空接口底层结构](../../assets/img/go语言系列/go面试题库/Interface面试题/iface修改.png)
...
![GMP调度模型架构图](../../assets/img/go语言系列/go面试题库/GMP面试题/image-1.png)
...
![GMP调度器获取Goroutine流程](../../assets/img/go语言系列/go面试题库/GMP面试题/image-2.png)
...
![Go m0和g0的作用示意图](../../assets/img/go语言系列/go面试题库/GMP面试题/image.png)
...
![Go内存分配mcache mcentral mheap结构](../../assets/img/go语言系列/go面试题库/内存管理面试题/image.png)
...
![Go垃圾回收三色标记法示意图](../../assets/img/go语言系列/go面试题库/垃圾回收面试题/image-3.png)
...
![三色标记法对象误回收问题](../../assets/img/go语言系列/go面试题库/垃圾回收面试题/image.png)
...
![Go GC各阶段触发函数](../../assets/img/go语言系列/go面试题库/垃圾回收面试题/image-1.png)
...
![Go pprof性能分析可视化界面](../../assets/img/go语言系列/go面试题库/垃圾回收面试题/image-2.png)
