...
description: "大模型Agent项目：基于 Go（Eino 框架）和 Java（Spring Boot + Spring AI Alibaba 框架）双语言各实现一套的 AI Agent 实战面试项目 InterviewAgent，涵盖多Agent编排、RAG多路召回、MCP协议、记忆系统、Skill技能系统等，配套双语言深度教程、50+面试题以及两套简历写法"
