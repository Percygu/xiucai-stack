---
title: 3. 正确的协作心态
description: Vibe Coding教程第3篇：用对 AI 编程的协作心态，比换工具更重要。讲清人和 AI 的分工——你负责想什么、AI 负责怎么做，拆解需求→指令→生成→验证→迭代的基本工作流，点破新手最容易踩的三个误区，并给出一条零基础也能照走的学习路线。
category:
  - Vibe Coding
tag:
  - Vibe Coding
