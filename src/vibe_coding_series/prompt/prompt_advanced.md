...
结果它给的表格功能太单薄，不能排序、不能翻页。这时按对号入座的思路一看，问题是信息不足，于是补要素、加约束，改成：
...
第二版立刻就到位了。你看，从第一版到第二版，AI 没变，变的是你诊断出问题、补上缺失信息的过程。这就是把写 Prompt 当成可调试的事的实际样子——不是一次写对，而是有方法地越改越准。值得强调的是，这种优化能力比记住任何一条具体技巧都重要。技巧会随工具更新，但观察结果、定位问题、改进表达这套循环是不变的。你越早把它当成一种可练习的方法，而不是凭手感碰运气，进步就越快。
